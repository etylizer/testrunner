...
foo(X) -> is_special(X).
-spec bar(binary() | integer()) -> boolean().
bar(B) when is_binary(B) -> foo(binary_to_integer(B));
bar(X) when 100 =< X, X =< 200 -> true;
bar(X) when 300 =< X, X =< 400 -> true;
bar(X) when 500 =< X, X =< 600 -> true;
bar(X) when 700 =< X, X =< 800 -> true;
bar(X) when 900 =< X, X =< 1000 -> true;
bar(X) when 1100 =< X, X =< 1200 -> true;
bar(X) when 1300 =< X, X =< 1400 -> true;
bar(X) when 1500 =< X, X =< 1600 -> true;
bar(X) -> is_special(X).
